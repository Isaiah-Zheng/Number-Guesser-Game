        ...
        def guessing(RanNum):    
            ...
            while True:
                ...
                try:
                    ...
                    print("Please input 'exit' and 'replay' if u want")
                    Opp = input("Please input your number or instruction > ")
                    if Opp.isdigit():
                        UserAns = int(Opp)
                        if UserAns < 0:
                        ...
                        menu_det = menu(Opp)
                        if menu_det == -1:
                            print("U exit successfully , thank u")
                            break
                        elif menu_det == -2:
                            print("U replay successfully , please go on")
                            break
                        else:
                            UserAns = int(Opp)
                    ...
                    print("It is not a number or instruction !")
